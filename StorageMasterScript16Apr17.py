...
def setKeyParameters():
    ...
    scenario = 'deep' #cpp, deep, solar, nuclear, ng, coalret, highSto, base, highStoEff, noco2price 
    co2CapScenario = 'deep' #cpp, deep, or none (deep = 80% redux from 1990 by 2050)
    runCE,runUC = False,True
    (startYear,endYear,yearStepCE) = (2045,2046,5) #start @ 2015 for CE
    daysPerSeason = 2
    ...
    stoScenarios = ['StoEnergy','StoRes','StoEnergyAndRes','NoSto'] #['NoSto','StoEnergy','StoRes','StoEnergyAndRes']
    ...
    calculateCO2Price = False
    # if scenario == 'noco2price': calculateCO2Price = False
    # else: calculateCO2Price = True
    (daysOpt,daysLA) = (1,1)
